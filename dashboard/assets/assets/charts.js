(function(){
  ...
  makeChart('chart-month', {
    ...
    yAxis:{type:'value',axisLabel:{color:muted,formatter:'{value}%'},splitLine:{lineStyle:{color:rule}}},
    series:[
      {name:'模型',type:'bar',data:[-6.76, 3.16, -7.01, 4.65, -6.04, 6.18, -9.16],itemStyle:{color:function(p){return p.value>=0?green:red}},barWidth:'30%'},
      {name:'沪深300',type:'bar',data:[-0.32, 0.02, -1.28, 5.58, 1.39, 5.17, -4.83],itemStyle:{color:function(p){return p.value>=0?'rgba(0,113,227,0.6)':'rgba(255,59,48,0.6)'}},barWidth:'30%'}
    ]
  });
  ...
  makeChart('chart-etf', {
    ...
    series:[{
      type:'bar',
      data:[46.2, 41.7, 33.3, 27.3, 55.6, 14.3, 33.3, 58.8, 36.4, 0.0, 50.0],
  ...
  makeChart('chart-rec', {
    ...
    legend:{data:['模型','沪深300'],textStyle:{color:ink},top:5},
    grid:{left:'3%',right:'4%',bottom:'3%',containLabel:true},
    xAxis:{type:'category',data:["06-30", "07-01", "07-02", "07-03", "07-06", "07-07", "07-08", "07-09", "07-10", "07-13", "07-14", "07-15", "07-16", "07-17", "07-20"],axisLabel:{color:muted,fontSize:10,rotate:30},axisLine:{lineStyle:{color:rule}}},
    yAxis:{type:'value',axisLabel:{color:muted,formatter:'{value}%'},splitLine:{lineStyle:{color:rule}}},
    series:[
      {name:'模型',type:'bar',data:[-0.36, -1.65, -0.56, -0.4, -0.97, 1.22, -0.68, 5.32, -2.39, -2.83, 2.19, 0.85, -0.13, -6.05, -3.09],itemStyle:{color:function(p){return p.value>=0?green:red}},barWidth:'30%'},
      {name:'沪深300',type:'bar',data:[1.46, -0.22, -2.12, 0.95, -0.47, -0.66, -0.79, 2.14, -1.81, -1.21, 1.96, 0.19, -0.46, -2.78, 0.43],itemStyle:{color:function(p){return p.value>=0?'rgba(0,113,227,0.5)':'rgba(255,59,48,0.5)'}},barWidth:'30%'}
    ]
  });
