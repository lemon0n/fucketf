(function(){
  ...
  makeChart('chart-month', {
    ...
    yAxis:{type:'value',axisLabel:{color:muted,formatter:'{value}%'},splitLine:{lineStyle:{color:rule}}},
    series:[
      {name:'模型',type:'bar',data:[-6.76, 3.16, -7.01, 4.65, -6.04, 6.18, -8.4],itemStyle:{color:function(p){return p.value>=0?green:red}},barWidth:'30%'},
  ...
  makeChart('chart-etf', {
    ...
    series:[{
      type:'bar',
      data:[53.3, 41.7, 31.2, 27.3, 52.6, 14.3, 33.3, 58.8, 36.4, 0.0, 50.0],
  ...
  makeChart('chart-rec', {
    ...
    yAxis:{type:'value',axisLabel:{color:muted,formatter:'{value}%'},splitLine:{lineStyle:{color:rule}}},
    series:[
      {name:'模型',type:'bar',data:[-0.97, 1.22, -0.68, 5.32, -2.39, -2.83, 2.19, 0.85, -0.13, -6.05, -3.09, 4.62, 0.67, -1.95, -2.57],itemStyle:{color:function(p){return p.value>=0?green:red}},barWidth:'30%'},
  ...
  makeChart('chart-imp', {
    ...
    tooltip:{trigger:'axis',appendToBody:true},
    grid:{left:'3%',right:'4%',bottom:'10%',containLabel:true},
    xAxis:{type:'category',data:["sentiment_score", "prev_intraday_return", "sector_mention_count", "prev_volume_ratio", "bullish_count", "bearish_count", "prev_change_pct", "sector_mentioned"],axisLabel:{color:muted,fontSize:9,rotate:25},axisLine:{lineStyle:{color:rule}}},
    yAxis:{type:'value',axisLabel:{color:muted},splitLine:{lineStyle:{color:rule}}},
    series:[{
      type:'bar',
      data:[0.054047, 0.04792, 0.006798, 0.002783, 0.0, 0.0, 0.0, 0.0],
